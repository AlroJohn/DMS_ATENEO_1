...
import { DOC_CLASSIFICATION_OPTIONS, DOC_STATUS_OPTIONS } from "@/lib/doc-enums";
...
export function DocumentFiltersModal<TData>({ 
  ...
  const documentColumn = table.getAllColumns().find(col => col.id === 'document');
  ...
  const getDocumentSearchValue = () => {
    return documentColumn ? (documentColumn.getFilterValue() as string || "") : "";
  };
